...
CORS(app, supports_credentials=True, origins=['http://localhost:5173','https://veersa-hack-c4cr.vercel.app/','https://veersa-hack-c4cr-wa6c7ty2i-meet-aroras-projects.vercel.app/'], allow_headers=['Content-Type'], methods=['GET', 'POST', 'OPTIONS'])
